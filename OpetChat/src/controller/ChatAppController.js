...
export class ChatAppController{
    constructor(){
        ...
        console.log('ChatAppController OK');
    ...
    //funcão para listar os contatos da base de dados.
    initContacts(){
    ...
    //funcão para pegar os id do front-end
    loadElements(){
    ...
    initEvents(){
        ...
        //essa parte criar os eventos dentro do e app assim como abrir paniel e fechar o mesmo
        ...
        //eventos de edição do formulário do edit profile e addcontact.
        ...
        this.el.formPanelAddContact.on('submit', e =>{
            ...
            contact.on('datachange', data=>{
                if (data.name){
                    //criando chat para conversar entre 2 usuario. depois estudar como criar grupos.
        ...
        //botão do menu de menssgens que tem a funcão de transferir foto ja existente na galeria ou nas pastas do pc.
        ...
        //botão do menu de menssgens que tem a funcão de de tirar fotos
        ...
        //############################################################################
        //botão do menu de menssgens que tem a funcão de tranferir documentos/arquivos
        //############################################################################
        ...
        this.el.btnSendDocument.on('click', e=>{
         ...
         //botão do menu de menssgens que tem a funcão de enviar contatos.
        ...
        this.el.btnSendMicrophone.on('click', e=>{
                ...
                this._microphoneController.on('ready', song=>{
    ...
    //metodos para falicitar o uso nas funções acima.
